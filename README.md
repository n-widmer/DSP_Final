...
One important thing to keep in mind is that we do not fully trust the cloud, and assume the cloud is
...
We assume the fields information is not sensitive.
4 Project Requirements
4.1 Basic Setup (5 pts total)
...
4.2 Security Features (25 pts total)
...
4.3 Project report (10 pts total)
The report should:
